...
public class SwingComponent {
	...
	// 创建"复制"菜单项，并为之指定图标
	JMenuItem copyItem = new JMenuItem("复制", new ImageIcon("ico/copy.jpg"));
	// 创建"粘贴"菜单项，并为之指定图标
	...
	JRadioButtonMenuItem metalItem = new JRadioButtonMenuItem("matal风格", true);
	...
	// ----------------------------用户执行界面初始化的init方法-------------------------------
	public void init() {
		// 创建一个装在了文本框、按钮的JPanel
		JPanel bottom = new JPanel();
		bottom.add(name);
		bottom.add(ok);
		f.add(bottom, BorderLayout.SOUTH);
		// 创建一个装在了下拉选择框、三个JCheckBox的Jpanel
		...
		// newItem.addActionListener(ta.append("用户单击了新建菜单\n"));
		// 为file菜单添加菜单项
		file.add(newItem);
		file.add(saveItem);
		file.add(exitItem);
